...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalExaggeration_checkbox = QtWidgets.QCheckBox(self.tab)
        self.verticalExaggeration_checkbox.setGeometry(QtCore.QRect(1100, 30, 200, 25))
        ...
        self.verticalExaggeration_checkbox.setChecked(True)
        ...
        self.verticalExaggeration_checkbox.stateChanged.connect(self.vertical_exaggeration_status)
        ...
        self.actionSave_as_DXF.triggered.connect(self.save_dxf)
        ...
        self.widget_geometries = {
            ...
            self.verticalExaggeration_checkbox: self.verticalExaggeration_checkbox.geometry()
            }
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.verticalExaggeration_checkbox.setText(_translate("MainWindow", "100x Vertical Exaggeration"))
...
# =============================================================================
    ...
    def create_plot (self):
        ...
        top_of_bottom = np.nanmax(self.formation_polygons[-1][0])
        ...
        if self.verticalExaggeration_checkbox.isChecked():
            vertical_exaggeration_ratio = ((self.locations[-1]) / (tallest_borehole - deepest_borehole)) / 100
            self.figsize[0] = vertical_exaggeration_ratio * self.figsize[1]
            self.figsize[1] = self.figsize[1]
            
        else:
            self.figsize[0] = self.default_figsize[0]
            self.figsize[1] = self.default_figsize[1]
        ...
        ax.fill_between(self.distance, top_of_bottom, self.elev, color="#FFE563")
        ...
        ax.fill_between(self.distance, self.elev, tallest_borehole+50, color='w', zorder = 13)
        ...
        ax.set_ylim(deepest_borehole-50, tallest_borehole+100)
    ...
    def calculate_polygons(self):
        ...
        for row in range(len(self.initial_polygon_list)-1, -1, -1):
...
########################################################################################################################################################################
    ...
    def save_dxf(self):
        ...
        doc.layers.add(name='Contact_Lines')
        ...
        for row, formation_chunk_list in formation_chunk_dict.items():
            ...
            for formation_chunk in formation_chunk_list:
                ...
                hatch.dxf.true_color = hex_to_rgb(self.colors_list[row])
        ...
        for line in self.solid_contacts:
            ...
            for i in range(line.shape[1]):
                line_points_list.append((line[-1, i], line[0, i]))
            msp.add_lwpolyline(line_points_list, dxfattribs={'layer':"Contact_Lines"})
        
        for line in self.dashed_contacts:
            line_points_list = []
            for i in range(line.shape[1]):
                line_points_list.append((line[-1, i], line[0, i]))
            msp.add_lwpolyline(line_points_list, dxfattribs={'linetype': 'DASHED', 'layer':"Contact_Lines"})
